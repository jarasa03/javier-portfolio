<div
    class="fixed inset-0 z-50 hidden items-center justify-center bg-slate-950/85 px-4 py-8"
    data-lightbox-modal
    aria-hidden="true"
>
    <button type="button" class="absolute inset-0 cursor-zoom-out" data-lightbox-backdrop aria-label="Cerrar visor"></button>
    <div class="relative z-10 w-full max-w-6xl">
        <div class="overflow-hidden rounded-[1.75rem] border border-white/10 bg-white shadow-2xl">
            ...
            <div class="bg-slate-50 p-4">
                <div class="overflow-hidden rounded-[1rem] bg-slate-100 p-4" data-lightbox-viewport>
                ...
                <div class="mt-4 flex items-center justify-between gap-4 rounded-[1rem] border border-slate-200 bg-white px-4 py-3">
